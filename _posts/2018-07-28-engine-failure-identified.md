---
categories: ["Engine"]
tags: [Engine Failure, Thompson Machine, Pistons, Valve Seals]
title: "Engine Build #1: A Costly Failure"
...
<div style="display: flex; justify-content: center; margin: 2rem 0;">
  <table style="border-collapse: collapse; width: 80%; max-width: 500px; text-align: center; font-family: sans-serif;">
    <thead>
      <tr style="background-color: #333; color: white;">
        <th style="padding: 12px; border: 1px solid #ddd;">Cylinder</th>
        <th style="padding: 12px; border: 1px solid #ddd;">Compression (PSI)</th>
        <th style="padding: 12px; border: 1px solid #ddd;">Leak-Down (%)</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td style="padding: 10px; border: 1px solid #ddd;">#1</td>
        <td style="padding: 10px; border: 1px solid #ddd;">141</td>
      ...
      <tr>
        <td style="padding: 10px; border: 1px solid #ddd;">#5</td>
        <td style="padding: 10px; border: 1px solid #ddd;">146</td>
        <td style="padding: 10px; border: 1px solid #ddd;">5%</td>
      </tr>
      <tr>
