...
Dirty ol' Chevy 250 Inline 6 - just put on the stand and is ready for disassembly
...
Replaced the damper a few months ago, should of painted it
...
No components on this side of the block... yet
...
Valve cover had a leak for a while but gasket was replaced a couple months ago
...
Starter solenoid was rebuilt in 2015. 
...
Car wouldn't start August 2015 so put in a new Delphi MF0019 fuel pump
...
Motor mounts are solid but need cleaning
...
Thermostat and water pump work fine, but need cleaning
...
Car had smog package when purchased - removed it and installed brass plugs
...
You can really see how much the valve cover leaked here
...
Years and grime and another filthy motor mount
...
Always hated the nuts on the exhaust manifold. Glad it's no more
...
Valve cover off, surprisingly clean in there despite all the orange paint
...
Starter, Water pump and thermostat housing removed. First look inside the block. Still a lot of fluid in there
...
Head unbolted. Hard to do with the engine stand on wheels as those bolts are tight.
...
Pistons don't look too bad actually and the deck is fairly smooth
...
They don't look as good as you get closer. New forged ones are standing by anyway
...
You might be able to see "60" on the piston. Yep, 0.060" oversized already
...
Spun the block over, removed the oil pan bolts
...
Oil filter, fuel pump and starter removed
...
Oil pan removed, front of the crank and oil pump
...
Back of the crank and oil pump head
...
The underside of the engine from a few feet back. Removed the dipstick by just wiggling it out
...
Underside of the engine from the other side
...
Removed the side covers and used a pair of needle nose pliers to pull the lifters out. They're garbage
...
Block painted with a VHT Metallic Black Pearl spray bomb. The engine re-build as officially started. (<a href="https://www.youtube.com/watch?v=LFl2QXqrkSQ" target="_blank">see video</a>)
...
The motor was pulled by separating the flexplate from the torque converter. The Turbo 350 transmission had a shift kit installed last year so there was no need to pull it with the motor. 
...
The block wasn't the only part painted. The Offenhauser script was finger painted on. The oil fill cap was replaced with a <a href="http://www.turbocamaro.ca/2016/02/breathers.html" target="_blank">Spectre chrome breather</a> and the PCV was replaced with a matching <a href="http://www.turbocamaro.ca/2016/02/breathers.html" target="_blank">chrome Spectre PCV</a>. This is a good picture to notice the lack of modern carb adapter plate on the manifold.
...
The manifolds are painted and torqued to the head. We had to wait almost a week for the 1/2" carb spacer and Trans-Dapt 2090 adapter plate. Both the spacer and adapter were required to mount the more modern Holley 4776 4 barrel carburetor. If your Offenhauser 5416 already has the plate, you'll just need the spacer for the throttle linkage to clear the intake flange. 
...
The initial timing was set for TDC and the distributor loosely clamped down. Radiator reinstalled and all associated hoses and fittings secured. 
