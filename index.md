...
<img src="{{ '/assets/img/tc_logo_tp.png' | relative_url }}" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 160px; height: auto; z-index: 1; opacity: 1 !important; visibility: visible !important;" class="no-lightbox" alt="Logo">
<img src="{{ '/assets/img/Racetrack2.png' | relative_url }}" class="spinning-track no-lightbox" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 2; opacity: 1 !important; visibility: visible !important;" alt="Racetrack">
</div>
</div>
